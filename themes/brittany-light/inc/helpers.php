<?php
function brittany_light_admin_notice_sample_content() {
	...
	$sample_content_url = apply_filters( 'brittany_light_sample_content_url',
		sprintf( 'https://www.cssigniter.com/sample_content/%s.zip', BRITTANY_LIGHT_NAME ),
	...
	?>
	<div class="notice notice-info is-dismissible brittany-light-sample-content-notice">
		<p>
			<?php echo wp_kses( sprintf( __( 'It looks like the theme was just installed. <a href="%s" target="_blank">Download the sample content</a> to get things moving.', 'brittany-light' ),
	...
	wp_enqueue_script( 'brittany-light-sample-content', get_template_directory_uri() . '/inc/js/sample-content.js', array(), $theme->get( 'Version' ), true );

	$settings = array(
		'ajaxurl'       => admin_url( 'admin-ajax.php' ),
		'dismiss_nonce' => wp_create_nonce( 'brittany-light-dismiss-sample-content' ),
	);
	wp_localize_script( 'brittany-light-sample-content', 'brittany_light_SampleContent', $settings );
}

function brittany_light_ajax_dismiss_sample_content() {
	check_ajax_referer( 'brittany-light-dismiss-sample-content', 'nonce' );
