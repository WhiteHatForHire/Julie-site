...
function brittany_light_admin_register_post_meta_scripts( $hook ) {
	...
	wp_register_style( 'brittany-light-post-meta', get_template_directory_uri() . '/inc/css/post-meta.css', array(), $theme->get( 'Version' ) );
...
function brittany_light_metabox_input( $fieldname, $label, $params = array() ) {
	...
	if ( ! empty( $label ) ) {
		?><label for="<?php echo esc_attr( $fieldname ); ?>" class="<?php echo esc_attr( $params['label_class'] ); ?>"><?php echo wp_kses( $label, brittany_light_get_allowed_tags() ); ?></label><?php
	}
...
function brittany_light_metabox_dropdown( $fieldname, $options, $label, $params = array() ) {
	...
	if ( ! empty( $label ) ) {
		?><label for="<?php echo esc_attr( $fieldname ); ?>"><?php wp_kses( $label, brittany_light_get_allowed_tags() ); ?></label><?php
	}
...
function brittany_light_metabox_radio( $fieldname, $optionname, $optionval, $label, $params = array() ) {
	...
	?>
		...
		<label for="<?php echo esc_attr( $optionname ); ?>" class="radio"><?php wp_kses( $label, brittany_light_get_allowed_tags() ); ?></label>
	<?php
	echo $params['after'];
}
...
function brittany_light_metabox_checkbox( $fieldname, $value, $label, $params = array() ) {
	...
	?>
		...
		<label for="<?php echo esc_attr( $fieldname ); ?>"><?php wp_kses( $label, brittany_light_get_allowed_tags() ); ?></label>
	<?php
	echo $params['after'];
}
